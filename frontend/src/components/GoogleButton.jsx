...
export default function GoogleButton({ label = 'Continue with Google' }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full h-[56px] md:h-[60px] rounded-2xl flex items-center justify-center gap-3 md:gap-4 shadow-sm transition-colors disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
      style={{
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.borderColor = '#b2def9';
      }}
      onMouseLeave={(e) => {
